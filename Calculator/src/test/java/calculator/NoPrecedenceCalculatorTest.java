...
public class NoPrecedenceCalculatorTest extends Application {
    ...
    public void start(Stage primaryStage) {
        Scene scene = new Scene(new NoPrecedenceCalculator());
        primaryStage.setTitle("Testing Calculator without Precedence");
    ...
    private void testResults() {
        NoPrecedenceCalculator calculator = new NoPrecedenceCalculator();
